...
As a member of the team that manages **traefik-allow-countries**, you have the following responsibilities:
...
- **Changes to build scripts, guidelines and things that might break the processes we have in place need to be reviewed by [@JonasSchubert](https://code.sinthu-und-jonas.de/jonas-schubert/)** (this is temporary, but we need a baseline to make sure we break as few things as possible in the beginning).
